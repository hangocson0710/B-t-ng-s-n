    ...
    <div class="ltn__product-item ltn__product-item-4 ltn__product-item-5 text-center---">
        <div class="product-img" style="max-height: 250px;height: 250px;">
            <a style="height: 100%" href="{{route('chi-tiet-tin',$item->classified_url)}}">
                <img style="object-fit: cover" class="w-100 h-100" src="{{asset(json_decode($item->classified_image)[0])}}" alt="#">
            </a>
        ...
        <div class="product-info">
            ...
            <ul class="ltn__list-item-2--- ltn__list-item-2-before--- ltn__plot-brief">
                <li><span>{{ optional($item->bed)->param_name }}</span> P.Ngủ</li>
                <li><span>{{ optional($item->toilet)->param_name }}</span> P.Vệ sinh</li>
                <li><span>{{ $item->classified_area }}</span> {{ optional($item->area)->unit_name }}</li>
            </ul>
