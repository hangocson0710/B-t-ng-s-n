                                                ...
                                                <div class="ltn__comment-area mb-50">
                                                    <div class="ltn-author-introducing clearfix">
                                                        ...
                                                        <div class="author-info">
                                                            ...
                                                            <h2>{{$param['user']->user->fullname}}</h2>
                                                                ...
                                                                <ul>
                                                                    <li>
                                                                        ...
                                                                        <div class="footer-address-info">
                                                                            <p>{{$param['user']->user->address.', '}}{{$param['user']->ward_name.', '}}{{$param['user']->district_name.', '}}{{$param['user']->province_name}}</p>
                                                                        </div>
                                                                    </li>
                                                                    <li>
                                                                        <div class="footer-address-icon">
                                                                        ...
                                                                        <div class="footer-address-info">
                                                                            <p><a href="tel:{{$param['user']->user->phone}}">{{$param['user']->user->phone}}</a></p>
                                                                        </div>
                                                                    </li>
                                                                    <li>
                                                                        <div class="footer-address-icon">
                                                                        ...
                                                                        <div class="footer-address-info">
                                                                            <p><a href="mailto:{{$param['user']->user->email}}">{{$param['user']->user->email}}</a></p>
                                                                        </div>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="input-item input-item-textarea  ltn__custom-icon">
                                                                        <input type="text" name="fullname" value="{{$param['user']->user->fullname}}" placeholder="Nhập tên">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="input-item input-item-textarea  ltn__custom-icon">
                                                                        <input type="text" name="phone" value="{{$param['user']->user->phone}}" placeholder="Nhập tên">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12">
                                                                    <div class="input-item input-item-textarea  ltn__custom-icon">
                                                                        <input type="text" name="address" value="{{$param['user']->user->address}}" placeholder="Nhập tên">
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="input-item">
                                                                        <select class="nice-select">
                                                                            ...
                                                                            @foreach($param['province'] as $i)
                                                                                <option value="{{$i->id}}" {{$i->id == $param['user']->user->province_id?"selected":""}}>{{$i->province_name}}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div>
                                                                </div>
