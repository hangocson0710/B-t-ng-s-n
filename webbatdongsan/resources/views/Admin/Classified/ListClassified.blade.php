<!-- resources/views/Admin/Classified/ListClassified.blade.php -->
                    ...
                    <div class="pb-20">
                        <table style="width: 100%" class="data-table table stripe hover nowrap">
                            ...
                            @foreach($param['classified'] as $item)
                                <tr>
                                    <td class="table-plus">{{$item->classified_title}}</td>
                                    <td><img style="max-height: 50px" src="{{asset(json_decode($item->classified_image)[0])}}"> </td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                <a class="dropdown-item" href="{{ route('admin.classified.show', $item->id) }}"><i class="dw dw-eye"></i> Xem bài viết</a>
                                                @if($item->is_deleted == 0 )
                                                    ...
                                                    @endif
                                                    <a class="dropdown-item" href="{{route('admin.classified.edit',$item->id)}}"><i class="dw dw-edit2"></i>Chỉnh sửa</a>
                                                @endif
                                                @if($item->is_deleted == 0 )
...
<script>
    $('.block-display').click(function (){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href='{{route('admin.classified.block','')}}/'+id;
            }
        })
    });
    $('.unblock-display').click(function (){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href='{{route('admin.classified.unblock','')}}/'+id;
            }
        })
    });
    ...
    $('.delete-item').click(function (){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href='{{route('admin.classified.delete','')}}/'+id;
            }
        })
    });
    ...
    $('.restore-item').click(function (){
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href='{{route('admin.classified.restore','')}}/'+id;
            }
        })
    });
