        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                ...
                <div class="card-box mb-30 pt-30">
                    <a href="{{route('admin.focus.add')}}" class=" ml-2 mb-3 btn btn-primary">Thêm</a>
                    <div class="pb-20">
                        <table style="width: 100%" class="data-table table stripe hover">
                            <thead>
                            <tr>
                                <th style="width: 30%" class="table-plus">Tiêu đề</th>
                                <th>Ảnh</th>
                                <th>Mô hình</th>
                                <th>Người đăng</th>
                                <th>Ngày đăng</th>
                            ...
                            <tr>
                                <td class="table-plus">{{$item->news_title}}</td>
{{--                                <td> {{$item->id}}</td>--}}
{{--                                <td class="table-plus">{{$item->news_url}}</td>--}}
                                 <td><img style="max-width: 150px" src="{{asset($item->news_image)}}"> </td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                            ...
                                            @endif
                                            <a class="dropdown-item" href="{{route('admin.focus.edit',$item->id)}}"><i class="dw dw-edit2"></i>Chỉnh sửa</a>
                                            @endif
                                            @if($item->is_deleted == 0 )
    ...
    <script>
        $('.block-display').click(function (){
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href='{{route('admin.focus.block_display','')}}/'+id;
                }
            })
        });
        $('.unblock-display').click(function (){
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href='{{route('admin.focus.unblock_display','')}}/'+id;
                }
            })
        });
        ...
        $('.delete-item').click(function (){
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href='{{route('admin.focus.delete','')}}/'+id;
                }
            })
        });
